...
function setup() {
  ...
  slingShot1 = new launcher(stoneObj.body, {x:200, y:400});
...
function draw() {
  ...
  slingShot1.display();
  // muestra el objeto lanzador aquís
...
if(keyCode === 32){
  console.log("presionar espacio funciona");
...
//para que al la piedraa pasar por lo smangos estos ya no esten estaticos  
//para que los mangos se caigan
function detectollision(lstone,lmango){
  ...
  function detectCollision(stoneObj,mango1){
